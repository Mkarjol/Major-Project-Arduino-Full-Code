...
//  Serial.println("%");
  ...
  ///////////////
  if (_moisture>=25||gaslevel>=1000||gaslevel1>=4000||distanceCm<=5||h>=60||t>=32){
    Alart=1;
    if(t>=32){
  ...
  if (Firebase.ready() && signupOK ) {
    ...
    if(Firebase.RTDB.setFloat(&fbdo, "DHT/Distance", distanceCm)){
          Serial.println("PASSED");
    ...
    if(Firebase.RTDB.setFloat(&fbdo, "DHT/Moisture", _moisture)){
          Serial.println("PASSED");
          Serial.print("Moisture : ");
    ...
    if(Firebase.RTDB.setFloat(&fbdo, "DHT/H2 Gaslevel",gaslevel)){
          Serial.println("PASSED");
    ...
    if(Firebase.RTDB.setFloat(&fbdo, "DHT/C2H2 Gaslevel",gaslevel1)){
          Serial.println("PASSED");
     ...
     ///////////////////////////////////////////////////
    //////////////////////////////////////////////////
    if(Firebase.RTDB.setBool(&fbdo, "DHT/Falt/Alarm",Alart)){
          //Serial.println("PASSED");
          Serial.print("Alart: ");
    ...
    if(Firebase.RTDB.setString(&fbdo, "DHT/Falt/Alarm_reason",Alart_message)){
          //Serial.println("PASSED");
  ...
  if(Firebase.RTDB.getBool(&fbdo, "DHT/Circuit_breaker")){
