...
void loop(){
  ...
  //Rec_Power = (voltage*current*(sqrt((pf*pf)-1)));
...
//  Serial.println("%");
  ...
  float Oil_level = (80*(22.5-distanceCm)/18);//calibration line
  ...
  if (_moisture>=25||gaslevel>=1000||gaslevel1>=4000||Oil_level<=50||h>=50||t>=45){
    Alart=1;
    if(t>=45){
