...
#define RatioMQ8CleanAir 120   //RS / R0 = 70(MQ8),4.4(MQ4),3.6(MQ135),27.5(MQ7),60(MQ3),9.6(MQ9) ppm  
#define RatioMQ6CleanAir 170   
#define RatioMQ7CleanAir 170   
...
void setup() {
  ...
  //MQ6.setR0(21.91);
  MQ6.init();
  MQ6.setA(17.1484); MQ6.setB(-0.4114); // Configurate the ecuation values to get C2H2 concentration
